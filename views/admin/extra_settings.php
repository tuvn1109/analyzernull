            ...
            <?php else: ?>
                <?php while($plugin = $plugins_result->fetch_object()): ?>
                    ...
                    <div class="media mb-3">
                        <div class="mr-3 plugin" style="background: <?= $plugin->color ?>"><i class="fab fa-<?= $plugin->identifier ?>"></i></div>
                        ...
                        <div>
                            ...
                            <?php else: ?>
                                ...
                                <?php if($plugin->identifier == 'twitch'): ?>
                                    <a href="https://gum.co/phpanalyzer-twitch" class="btn btn-sm btn-success"><i class="fa fa-cloud-download-alt"></i> <?= $language->admin_extra_settings->display->get ?></a>
                                <?php else: ?>
